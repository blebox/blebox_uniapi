$custom_name = Read-Host "Enter a name (use underscores for spaces)"
...
$yaml_content | Out-File -FilePath "${custom_name}.yaml"

Write-Output "YAML file '${custom_name}.yaml' generated successfully."